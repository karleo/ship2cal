...
@section('content')
    ...
    <form action="{{ route('shipment_rates.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            ...
            <div class="weight-rate mb-3">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="weight_rates[0][name]" required>
                    </div>
                    <div class="col">
                        <label class="form-label">Value</label>
                        <input type="number" class="form-control" name="weight_rates[0][value]" step="0.01" min="0" required>
                    </div>
                    <div class="col-auto">
            ...
            <div class="charge mb-3">
                <div class="row">
                    <div class="col">
                        ...
                        <select class="form-select" name="charges[0][type]" required>
                    ...
                    <div class="col">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control" name="charges[0][name]" required>
                    </div>
                    <div class="col">
                        <label class="form-label">Amount</label>
                        <input type="number" class="form-control" name="charges[0][amount]" step="0.01" min="0" required>
                    </div>
                    <div class="col-auto">
                        <label class="form-label">&nbsp;</label>
